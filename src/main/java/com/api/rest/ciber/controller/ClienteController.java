...
public class ClienteController {
	...
	public Map<String, Boolean> Cliente(@PathVariable(value = "id_cliente") Long clienteId) throws ResourceNotFoundException {
		Cliente cliente = clienteDAO.findById(clienteId).orElseThrow(() -> new ResourceNotFoundException("No se encontró un cliente con el id: " + clienteId));
	...
	public ResponseEntity<Cliente> updateCliente(@PathVariable(value = "id_cliente") Long clienteId, @RequestBody Cliente clienteDetails) throws ResourceNotFoundException {
		Cliente cliente = clienteDAO.findById(clienteId).orElseThrow(() -> new ResourceNotFoundException("No se encontró un cliente para el id: " + clienteId));
